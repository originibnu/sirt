<?php $__env->startSection('step'); ?>
    ...
    <div class="grid grid-cols-2 gap-4 mb-6">
        ...
        <?php if(config('installer.admin_area')): ?>
            <div>
                <p class="pb-3 text-gray-800">
                ...
                <?php if(config('installer.admin_area.user')): ?>
                    <p class="pb-3 text-gray-800">
                        Email: <b><?php echo e(config('installer.admin_area.user.email')); ?></b>
                        <br>
                        Password: <b><?php echo e(config('installer.admin_area.user.password')); ?></b>
                    </p>
                <?php endif; ?>
            </div>
        <?php endif; ?>
...
<?php echo $__env->make('installer::install', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sirt\resources\views/vendor/installer/steps/finish.blade.php ENDPATH**/ ?>