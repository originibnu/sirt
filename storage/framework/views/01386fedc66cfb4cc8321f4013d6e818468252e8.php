...
<?php $__env->startSection('content'); ?>
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">
                <?php echo e(__('create') . ' ' . __('timetable')); ?>
                            ...
                            <div class="form-group col-12">
                                ...
                                <select required name="class_section_id" id="timetable_class_section" class="col-md-6 col-sm-12 form-control select2" style="width:100%;" tabindex="-1" aria-hidden="true">
                                    ...
                                    <?php $__currentLoopData = $class_sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($section->id); ?>" data-class="<?php echo e($section->class->id); ?>"><?php echo e($section->class->name.' '.$section->section->name.' - '.$section->class->medium->name); ?> <?php echo e($section->class->streams->name ?? ' '); ?></option>
                                ...
                                <div class="tab-pane fade active show" id="monday" role="tabpanel" aria-labelledby="monday-tab">
                                    <div class="media">
                                        <div class="media-body">
                                            <?php echo $__env->make('timetable.tab_title', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                            <div data-repeater-list="monday_group" class="set_monday">
                                                <div data-repeater-item class="row mb-2 monday_count">
                                                    <?php echo $__env->make('timetable.addmore', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                </div>
                                            </div>
                                            <?php echo $__env->make('timetable.tab_footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        </div>
                                    </div>
                                </div>
...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        function set_subject() {
            ...
            $.ajax({
                url: "<?php echo e(url('get-subject-by-class-section')); ?>",
                type: "GET",
                data: {
                    class_id: class_id
                },
        ...
        function set_teacher_data() {
            for (let k = 0; k < total_row; k++) {
                $('select[name="' + tab + '_group[' + k + '][subject_id]"]').on('change', function (e) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('getteacherbysubject')); ?>",
                        type: "GET",
                        data: {
        ...
        function checktimetable(day_name) {
            ...
            var class_section_id = $('#timetable_class_section').val();
            $.ajax({
                url: "<?php echo e(url('checkTimetable')); ?>",
                type: "GET",
                data: {
                    class_section_id: class_section_id,
                    day: day
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wrteam-dev/eschool/resources/views/timetable/index.blade.php ENDPATH**/ ?>