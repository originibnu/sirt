...
<?php $__env->startSection('content'); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-5">
                                    ...
                                    <select name="type" id="type" class="form-control type">
                                        ...
                                        <option value="textarea"><?php echo e(_('Textarea')); ?></option>
                                        <option value="file"><?php echo e(__('File Upload')); ?></option>
                                    </select>
                                </div>
                                <div class="form-group col-sm-12 col-md-2 mt-3">
                                    <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="button" class="btn btn-success" id="preview-fields" data-toggle="modal" data-target="#previewFieldModal"><?php echo e(__('preview').' '.__('form_fields')); ?></button>
                        </div>
                        <table aria-describedby="mydesc" class='table table-striped' id='table_list' data-toggle="table"
                        data-url="<?php echo e(route('form-fields.show', 1)); ?>" data-click-to-select="true" data-side-pagination="server"
                        data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true"
                        data-show-columns="true" data-show-refresh="true" data-fixed-columns="true" data-reorderable-rows="true"
                        data-fixed-number="2" data-fixed-right-number="1" data-trim-on-search="false"
                        data-mobile-responsive="true" data-sort-name="id" data-toolbar="#toolbar" data-sort-order="asc"
                        data-maintain-selected="true" data-export-types='["txt","excel"]'
                        data-export-options='{ "fileName": "<?php echo e(__('form-fields')); ?>-<?= date(' d-m-y') ?>" ,"ignoreColumn":["operate"]}'
                        data-show-export="true" data-query-params="formFieldQueryParams">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" data-field="operate" data-sortable="false" data-events="formFieldsEvents"><?php echo e(__('action')); ?></th>
                                </tr>
                            </thead>
                        </table>
    ...
    <div class="modal fade" id="previewFieldModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> <?php echo e(__('Admission Form Preview')); ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true"><i class="fa fa-close"></i></span>
                    </button>
                </div>
                                    ...
                                    <div class="col-md-10">
                                        <?php $__currentLoopData = json_decode($row->default_values); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $options): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($options != null): ?>
                                                <div class="form-check form-check-inline">
                                                    <label class="form-check-label">
                                                        <input type="checkbox" name="<?php echo e($row->name); ?>">
                                                        <?php echo e(ucfirst($options)); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wrteam-dev/eschool/resources/views/form_fields/index.blade.php ENDPATH**/ ?>