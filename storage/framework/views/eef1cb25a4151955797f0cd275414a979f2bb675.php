                ...
                <div class="col-md-4 stretch-card grid-margin">
                    <div class="card bg-gradient-danger card-img-holder text-white">
                        <div class="card-body">
                            ...
                            <h4 class="font-weight-normal mb-3"><?php echo e(__('total_teachers')); ?><i class="mdi mdi-chart-line mdi-24px float-right"></i>
                            </h4>
            ...
            <?php if($student): ?>
                <div class="col-md-4 stretch-card grid-margin">
                    <div class="card bg-gradient-info card-img-holder text-white">
                        <div class="card-body">
                            <img src="<?php echo e(asset(config('global.CIRCLE_SVG'))); ?>" class="card-img-absolute" alt="circle-image"/>
                            <h4 class="font-weight-normal mb-3"><?php echo e(__('total_students')); ?><i class="mdi mdi-bookmark-outline mdi-24px float-right"></i>
                            </h4>
            ...
            <?php if($parent): ?>
                <div class="col-md-4 stretch-card grid-margin">
                    <div class="card bg-gradient-success card-img-holder text-white">
                        <div class="card-body">
                            <img src="<?php echo e(asset(config('global.CIRCLE_SVG'))); ?>" class="card-img-absolute" alt="circle-image"/>
                            <h4 class="font-weight-normal mb-3"><?php echo e(__('total_parents')); ?><i class="mdi mdi-diamond mdi-24px float-right"></i>
                            </h4>
                ...
                <div class="col-md-6 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body v-scroll attendance">
                            <h4 class="card-title"> <?php echo e(__('top_rankers')); ?> <i class='fa fa-trophy' style='font-size:30px;color:rgb(255, 200, 0); position:sticky;'></i></h4>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <th> <?php echo e(__('class_name')); ?></th>
                                            <th> <?php echo e(__('student_name')); ?></th>
                                        ...
                                        <?php $__currentLoopData = $rankers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo e($row->class_section->class->name); ?> - <?php echo e($row->class_section->section->name); ?> <?php echo e($row->class_section->class->medium->name); ?> <?php echo e($row->class_section->class->streams->name ?? ''); ?></td>
                                                <td><?php echo e($row->student->user->first_name); ?> <?php echo e($row->student->user->last_name); ?></td>
                    ...
                    <div class="card">
                        <div class="card-body v-scroll">
                            ...
                            <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="wrapper d-flex align-items-center py-2 border-bottom">
                                    <img class="img-sm rounded-circle" src="<?php echo e($row->user->image); ?>" alt="profile" onerror="onErrorImage(event)">
                                    ...
                                    <div class="col-md-2 stretch-card grid-margin">
                                        <div class="card <?php echo e($currentColor); ?> card-img-holder text-white">
                                            <div class="card-body">
                                                <img src="<?php echo e(asset(config('global.CIRCLE_SVG'))); ?>" class="card-img-absolute" alt="circle-image" />
                                                <h6 class="mb-2">
                                                    <h4><?php echo e($class_section->class->name); ?>-<?php echo e($class_section->section->name); ?> <?php echo e($class_section->class->medium->name); ?> <?php echo e($class_section->class->streams->name ?? ''); ?></h4>
                                                </h6>
                                            </div>
                                        </div>
                                    </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        <?php $__currentLoopData = $attendance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            xValues.push("<?php echo e($data->class_section->class->name ?? ''); ?> - <?php echo e($data->class_section->section->name ?? ''); ?> <?php echo e($data->class_section->class->medium->name ?? ''); ?> <?php echo e($data->class_section->class->streams->name ?? ''); ?>");
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wrteam-dev/eschool/resources/views/home.blade.php ENDPATH**/ ?>