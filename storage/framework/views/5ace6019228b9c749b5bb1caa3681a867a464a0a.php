                        ...
                        <table aria-describedby="mydesc" class='table table-striped' id='table_list' data-toggle="table"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" data-field="subject" data-sortable="true"><?php echo e(__('subject')); ?></th>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wrteam-dev/eschool/resources/views/assignment/submission.blade.php ENDPATH**/ ?>